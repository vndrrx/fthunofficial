...
$dbforsale= query( "SELECT * FROM forsale" );

// tombol cari diteken
if( isset($_POST["telusuri"]) ){

	$dbforsale = telusuri($_POST["keyword"]);
...
<div class="container mt-5">
	<div class="judul-produk" style="background-color: #232323; padding: 5px 10px;">
		<h5 class="text-center" style="margin-top: 5px; color:#fff;">FORSALE</h5>
	</div>
</div>
<!-- Akhir Navbar Produk -->
...
<div class="container-box">
	<div class="search-box">
		<div class="search-icon">
			<button type="submit" name="telusuri" class="boxz"><i class="fa-sharp fa-solid fa-magnifying-glass"></i></button>
					</div>
	...
	<div class="row">
		...
		<div class="card text-center">
		  ...
		  <div class="card-body">
		    ...
		    <a href="https://www.tokopedia.com/faithindustries/product" type="submit" class="btn btn-dark d-grid">Beli</a>
		  </div>
		</div>
