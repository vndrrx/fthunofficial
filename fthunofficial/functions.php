...
function tambah($data){
	...
	$query = "INSERT INTO forsale
				VALUES
				('', '$nama', '$gambar', '$harga_barang')
				";
	...
	if( $errorFile === 4 ) {
		...
		echo "
			...
			<script>
				...
				alert('Pilih gambar mana yang mau diupload!');
...
// lolos dalam segala hal
	// cek jika nama file sama
...
function ubah($data){
	...
	// cek apakah gambar lama tidak diganti
